package com.zenith.udl.renderblender.api.client.render;

import com.google.common.collect.ImmutableList;
import com.mojang.blaze3d.vertex.*;
import com.zenith.udl.renderblender.api.client.model.CachedFormat;
import com.zenith.udl.renderblender.api.client.render.buffer.ISpriteAwareVertexConsumer;
import com.zenith.udl.renderblender.api.client.render.buffer.TransformingVertexConsumer;
import com.zenith.udl.renderblender.api.client.render.lighting.LC;
import com.zenith.udl.renderblender.api.client.render.lighting.LightMatrix;
import com.zenith.udl.renderblender.api.client.render.lighting.PlanarLightModel;
import com.zenith.udl.renderblender.api.client.render.pipeline.CCRenderPipeline;
import com.zenith.udl.renderblender.api.client.render.pipeline.IVertexOperation;
import com.zenith.udl.renderblender.api.client.render.pipeline.IVertexSource;
import com.zenith.udl.renderblender.api.client.render.pipeline.VertexAttribute;
import com.zenith.udl.renderblender.api.client.render.pipeline.attribute.*;
import com.zenith.udl.renderblender.api.client.render.pipeline.attribute.*;
import com.zenith.udl.renderblender.api.client.util.colour.Colour;
import com.zenith.udl.renderblender.api.client.util.colour.ColourRGBA;
import com.zenith.udl.renderblender.api.utils.vec.Matrix4;
import com.zenith.udl.renderblender.api.utils.vec.Vector3;
import com.zenith.udl.renderblender.api.utils.vec.Vertex5;
